...
class ApiClientSession(garminconnect.ApiClient):
    ...
    def get(self, addurl, aditional_headers=None, params=None):
        ...
        try:
            response = self.session.get(url, headers=total_headers, params=params, cookies=cookies)
    ...
    def post(self, addurl, aditional_headers, params, data):
        ...
        try:
            response = self.session.post(
                url, headers=total_headers, params=params, data=data, cookies=cookies
            )
            response.raise_for_status()
            # logger.debug("Response: %s", response.content)
            return response
...
class GarminSession(garminconnect.Garmin):
    ...
    def logincookies(self, displayname, cookies):
        self.display_name = displayname
        self.cookies = cookies
        self.modern_rest_client.set_cookies(cookies)
        return True               
