...
#cachedata['multiprocess_manager'] = manager_dict
...
def ranking(request):
    ...
    #http = StreamingHttpResponse( stream_response_generator(usuario, password, fecha), content_type='text/plain')
    #http = StreamingHttpResponse()
    #http.content_type = 'text/plain'
    #http.headers = {'X-Accel-Buffering' : 'no'}
    #http.streaming_content =  stream_response_generator(usuario, password, fecha)

    http = StreamingHttpResponse( stream_response_generator(usuario, password, fecha), content_type='text/plain' , headers = {'X-Accel-Buffering' : 'no'} )
    #http['X-Accel-Buffering'] = 'no'
    #http['Content-Encoding'] = 'none'
